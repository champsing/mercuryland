  ...
  <div class="flex flex-col gap-4">
    <div class="flex gap-2">
      ...
      <div class="flex flex-col gap-2 w-1/4">
        <AddSteam :textarea-ref="textareaRef" @insert-html="insertHtml" />
        <AddYoutube :textarea-ref="textareaRef" @insert-html="insertHtml" />
        <AddImage :textarea-ref="textareaRef" @insert-html="insertHtml" />
        <AddSyntax :textarea-ref="textareaRef" @insert-html="insertHtml" />
        <AddPenaltyBtn :textarea-ref="textareaRef" @insert-html="insertHtml" />
      </div>
    </div>
    <!-- 预览 -->
