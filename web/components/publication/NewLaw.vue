...
<template>
  <div class="flex flex-row justify-center gap-32">
    ...
    <div class="flex flex-col text-center">
      ...
      <div class="text-xl text-red-400 mt-4">修訂之條文於公告一週後實施。</div>
      <div class="text-2xl text-lime-400 mt-4">公告日期：{{ publishDate }}</div>
      <div class="text-3xl text-emerald-200 font-bold mt-4">
        生效日期：{{ effectiveDate }}
      </div>
    </div>
  </div>
