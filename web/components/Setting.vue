...
<template>
    ...
    >
        <div class="flex flex-col gap-4 p-4">
            ...
            />
            <p v-if="vodUploadError" class="text-sm text-red-400">{{ vodUploadError }}</p>
            ...
            <div class="flex justify-end gap-2">
                ...
                <VaButton color="info" :loading="isVodUploading" @click="submitVodUpload">
                    確認上傳
                </VaButton>
            </div>
        </div>
