...
<template>
  ...
  >
    <div class="flex flex-col gap-4 p-4">
      ...
      <p v-if="editVodError" class="text-sm text-red-400">{{ editVodError }}</p>
    ...
    >
      <div class="flex flex-col gap-4 p-4">
        <div class="text-lg font-semibold text-red-300">確認刪除直播？</div>
        ...
        <div class="flex justify-end gap-2">
          ...
          <VaButton color="danger" :loading="isDeletingVod" @click="deleteVod">
            確認刪除
          </VaButton>
        </div>
      </div>
