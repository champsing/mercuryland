...
<template>
  ...
  <div class="m-auto flex w-full flex-col items-center">
    <div class="w-11/12">
      ...
      <ol>
        <li>
          ...
          <ol>
            ...
            <li>
              您的瀏覽紀錄、IP 地址、裝置資訊等技術資料。
            </li>
            <li>
              您與本網站的互動記錄，例如客服對話、回饋意見。
            </li>
          </ol>
        </li>
        <li class="mt-2">
      ...
      <ol>
        <li>本網站可能包含指向其他網站的連結。本網站無法控制這些第三方網站的隱私政策及其資料處理方式。</li>
      ...
      <ol>
        <li>本網站保留隨時修改本隱私政策的權利。若有重大變更，本網站將透過電子郵件或網站公告通知您。建議您定期查閱本政策，以確保瞭解最新內容。</li>
      </ol>
      <h1 class="text-lg mt-4">七、聯絡方式</h1>
      <ol>
        <li>若您對本隱私政策有任何疑問，或需行使您的個人資料權利，請使用電子郵件，或前往「聯絡我們」分頁尋找網站管理人員的Discord，本網站將竭誠為您服務。</li>
      </ol>
