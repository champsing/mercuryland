    ...
    let options = poise::FrameworkOptions {
        commands: vec![
            poise::Command {
                ...
                description: Some(
                    String::from("Fetch the text in the Drawn Zone of the specified wheel")
                ),
                description_localizations: HashMap::from([
                    (zh_tw.clone(), String::from("獲取輪盤抽中區")),
                ]),
            ...
            poise::Command {
                ...
                description_localizations: HashMap::from([
                    (zh_tw.clone(), String::from("查詢水星幣餘額")),
                ]),
            ...
            poise::Command {
                ...
                description_localizations: HashMap::from([
                    (zh_tw.clone(), String::from("（管理）給予使用者水星幣。可支援正或負數。")),
                ]),
            ...
            poise::Command {
                ...
                description: Some(
                    String::from("Link your Discord account to your YouTube channel record")
                ),
                description_localizations: HashMap::from([
                    (
                        zh_tw.clone(),
            ...
            poise::Command {
                ...
                description: Some(
                    String::from("Unlink your Discord account and your YouTube channel record")
                ),
                description_localizations: HashMap::from([
                    (zh_tw.clone(), String::from("斷開 YouTube 頻道與 Discord 帳號的連結")),
                ]),
                help_text: Some(
                    String::from(
                        format!(
            ...
            poise::Command {
                ...
                description_localizations: HashMap::from([
                    (zh_tw.clone(), String::from("顯示指令使用教學")),
                ]),
            ...
            poise::Command {
                ...
                description_localizations: HashMap::from([
                    (zh_tw.clone(), String::from("退款相關指令")),
                ]),
                ...
                subcommands: vec![
                    poise::Command {
                        ...
                        description: Some(
                            String::from("[ADMIN] Close a Mercury Coin refund request")
                        ),
                        description_localizations: HashMap::from([
                            (zh_tw.clone(), String::from("（管理）將討論串案號結單")),
                        ]),
                    ...
                    poise::Command {
                        ...
                        description: Some(
                            String::from("[ADMIN] Reopen a Mercury Coin refund request")
                        ),
                        description_localizations: HashMap::from([
                            (zh_tw.clone(), String::from("（管理）將討論串案號重新開啟")),
                        ]),
            ...
            poise::Command {
                ...
                description_localizations: HashMap::from([
                    (zh_tw.clone(), String::from("使用水星幣購買商品")),
                ]),
                ...
                subcommands: vec![
                    poise::Command {
                        ...
                        description_localizations: HashMap::from([
                            (zh_tw.clone(), String::from("購買懲罰加倍卡")),
                        ]),
                        help_text: Some(
                            String::from("購買懲罰加倍卡，使用後可將懲罰在轉盤上的機率加倍。")
                        ),
                        ..purchase::booster()
                    },
                    poise::Command {
                        ...
                        description: Some(
                            String::from("Purchase an overtime to force 20 stream overtime.")
                        ),
                        description_localizations: HashMap::from([
                            (zh_tw.clone(), String::from("購買加班台時數")),
                        ]),
                        help_text: Some(
                            String::from("購買加班台時數卡，可以增加惡靈剩餘的加班台時數。")
                        ),
                        ..purchase::overtime()
                    }
                ],
